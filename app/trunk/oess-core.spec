...
Requires: perl-OESS-Database >= 1.0.8
Requires: perl-OESS-Notification >= 1.0.8
Requires: perl-OESS-Topology >= 1.0.8
Requires: perl-OESS-Measurement >= 1.0.8
Requires: perl-OSCARS-Client >= 1.0.8
Requires: perl-OESS-DBus >= 1.0.8
BuildArch:	noarch
AutoreqProv: no
%description
