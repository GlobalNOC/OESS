...
BuildRequires:	perl
<<<<<<< HEAD
Requires:	perl-OESS >= 1.1.5b, perl(Net::DBus),dbus,dbus-libs,mysql-server,oess-core
Requires:       nox >= 0.10.5
=======
Requires:	perl-OESS >= 1.1.6, perl(Net::DBus),dbus,dbus-libs,mysql-server,oess-core
Requires:       nox >= 0.10.6
>>>>>>> 1b91fbcb90fba95628e12bbc17ed3bb9a75b8640
Requires:       yui2
