...
function NDDIMap(div_id, interdomain_mode, options){
  ...
  this.showNode = function(node_name, draw_other_data, node_info, keep_map_position, loop_node){
      ...
      var southbound = node_info.southbound;
