...
function page_init(){ 
  ...
  if((session.data.circuit_workgroup.workgroup_id == session.data.workgroup_id || [% is_admin %] == 1) && (session.data.workgroup_role === 'normal' || session.data.workgroup_role === 'admin')){
