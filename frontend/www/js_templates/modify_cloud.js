...
class GlobalState extends Component {
  ...
  async selectConnection(id) {
    if (id != -1) {
      ...
      this.history = await getConnectionHistory(id);
...
async function update() {
  ...
  state.connection.endpoints.map(function(e, i) {
    ...
    e.editable = editable;
    e.isPeeringAutoGenerated = (e.cloud_interconnect_type !== null && e.cloud_interconnect_type !== 'aws-hosted-connection' && e.cloud_interconnect_type !== 'gcp-partner-interconnect');
    ...
    e.peers.map(function(p, j) {
      ...
      p.endpointIndex = i;
      p.editable = editable;
      p.isPeeringAutoGenerated = (e.cloud_interconnect_type !== null && e.cloud_interconnect_type !== 'aws-hosted-connection' && e.cloud_interconnect_type !== 'gcp-partner-interconnect');
