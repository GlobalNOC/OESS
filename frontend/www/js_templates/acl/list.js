    ...
    let rows = acls.map((acl) => {
      ...
      <tr>
        <td style="white-space: nowrap; width:1%;">
          <button type="button" class="btn btn-default" onclick="document.components[${this._id}].state.onClickIncreasePriority(${acl.interface_acl_id}, ${acl.eval_position}, '${acl.allow_deny}', ${acl.start}, ${acl.end}, ${acl.workgroup_id}, ${acl.entity_id})">
            <span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span>
          </button>
          <button type="button" class="btn btn-default" onclick="document.components[${this._id}].state.onClickDecreasePriority(${acl.interface_acl_id}, ${acl.eval_position}, '${acl.allow_deny}', ${acl.start}, ${acl.end}, ${acl.workgroup_id}, ${acl.entity_id})">
